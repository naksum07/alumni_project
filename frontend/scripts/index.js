    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        try {
            ...
            stories.forEach((story, idx) => {
                ...
                slide.className = 'w-full min-w-full min-w-0 shrink-0 flex flex-col md:flex-row items-center md:items-start justify-center gap-6 sm:gap-8 md:gap-10 lg:gap-14 px-8 sm:px-14 md:px-20 lg:px-24 py-4 sm:py-6 select-none';
                ...
                <div class="flex-1 min-w-0 max-w-4xl w-full flex flex-col justify-center text-center md:text-left" data-aos="fade-up" data-aos-delay="250">
